            ...
            <div className="zs-node">
              <div
                ...
                style={{
                  ...
                  color: def.colorHex,
                  boxShadow: z.state === 'active' ? `0 0 12px ${def.colorHex}` : undefined,
                }}
              />
              <div style={{
                fontSize: 11,
                ...
                color: z.state === 'future' ? DS.text3 : (z.state === 'active' ? DS.gold : DS.text2),
              }}>
                {def.shortName}
              </div>
              <div style={{
                ...
                fontWeight: z.state === 'active' ? 600 : 400,
              }}>
                {z.duration}
              </div>
            </div>
