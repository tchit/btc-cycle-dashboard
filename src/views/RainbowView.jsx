      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <div style={{ marginTop: 20, padding: '16px 18px', background: DS.surface2, borderRadius: 10, border: `1px solid ${DS.borderLight}` }}>
            <div style={{ fontSize: 16, fontWeight: 700, color: DS.text, marginBottom: 10 }}>Comment lire ce graphique ?</div>
            <div style={{ fontSize: 15, color: DS.text2, lineHeight: 1.7 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: mob ? '1fr' : '1fr 1fr', gap: 12, marginTop: 14 }}>
              <div style={{ padding: '10px 12px', background: DS.surface, borderRadius: 8, border: `1px solid ${DS.borderLight}` }}>
                <div style={{ fontSize: 14, fontWeight: 600, color: DS.accent, marginBottom: 4 }}>Bande foncee (P25-P75)</div>
                <div style={{ fontSize: 14, color: DS.text3, lineHeight: 1.5 }}>50% des simulations tombent dans cette zone. C'est le scenario le plus probable.</div>
              </div>
              <div style={{ padding: '10px 12px', background: DS.surface, borderRadius: 8, border: `1px solid ${DS.borderLight}` }}>
                <div style={{ fontSize: 14, fontWeight: 600, color: DS.accent, marginBottom: 4, opacity: 0.6 }}>Bande claire (P5-P95)</div>
                <div style={{ fontSize: 14, color: DS.text3, lineHeight: 1.5 }}>90% des simulations. Les extremites representent les scenarios bull/bear extremes.</div>
              </div>
              <div style={{ padding: '10px 12px', background: DS.surface, borderRadius: 8, border: `1px solid ${DS.borderLight}` }}>
                <div style={{ fontSize: 14, fontWeight: 600, color: DS.accent, marginBottom: 4 }}>Ligne mediane (P50)</div>
                <div style={{ fontSize: 14, color: DS.text3, lineHeight: 1.5 }}>La trajectoire mediane : autant de simulations au-dessus qu'en-dessous.</div>
              </div>
              <div style={{ padding: '10px 12px', background: DS.surface, borderRadius: 8, border: `1px solid ${DS.borderLight}` }}>
                <div style={{ fontSize: 14, fontWeight: 600, marginBottom: 4 }}>
                  <span style={{ color: DS.up }}>P95</span> / <span style={{ color: DS.down }}>P5</span>
                </div>
                <div style={{ fontSize: 14, color: DS.text3, lineHeight: 1.5 }}>P95 (vert) = scenario tres haussier. P5 (rouge) = scenario tres baissier.</div>
              </div>
            </div>
            <div style={{ fontSize: 14, color: DS.text3, marginTop: 12, fontStyle: 'italic', lineHeight: 1.5 }}>
